    ...
    <>
      <section className="relative w-full h-[90vh] min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-30 flex flex-col items-center justify-center w-full h-full text-center px-4">
          ...
          <button
            onClick={openForm}
            className="bg-blue-600 text-white px-8 py-4 rounded-full font-semibold text-lg shadow-lg hover:bg-blue-700 transition-colors duration-150 cursor-pointer"
          >
            Start Consultation
          </button>
        </div>
